...
export const performance = {
  ...
  testimonialQuote: 'Argide is in a completely different league. It\'s now involved in 65% of conversations and ',
  testimonialHighlight: 'successfully resolves up to 81% end-to-end – even the more complex ones.',
  ...
  videoTitle: 'Build vs. buy: Why Anthropic chose',
  videoItems: [
    { status: 'NOW PLAYING', title: 'Build vs. buy: Why Anthropic chose' },
  ...
  cards: [
    {
      ...
      features: [
        { name: 'Browser-use navigation', included: false },
        { name: 'Advanced automation workflows', included: false },
        { name: 'Autonomous product indexing', included: false },
        { name: 'Unlimited conversations', included: true },
        { name: 'API & data source connections', included: false },
        { name: 'Knowledge base integration', included: true },
        { name: 'SOC2, GDPR compliance', included: false },
        { name: 'Dedicated support & onboarding', included: false },
      ],
      cta: 'Contact sales',
    },
    {
      ...
      features: [
        { name: 'Browser-use navigation', included: true },
        { name: 'Advanced automation workflows', included: true },
        { name: 'Autonomous product indexing', included: true },
        { name: 'Unlimited conversations', included: true },
        { name: 'API & data source connections', included: true },
        { name: 'Knowledge base integration', included: true },
        { name: 'SOC2, GDPR compliance', included: true },

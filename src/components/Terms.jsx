  ...
  return (
    <main className="policy-page terms-page">
      <div
        ...
        role="img"
        aria-label="Argide terms of service"
      >
      ...
      <div className="policy-container">
        <section id="interpretation-definitions" className="policy-section">
          <h2>Interpretation and Definitions</h2>
          <h3 className="security-subhead">Interpretation</h3>
          <p>
            The words of which the initial letter is capitalized have meanings defined under the
            following conditions. The following definitions shall have the same meaning regardless
            of whether they appear in singular or in plural.
          </p>
          <h3 className="security-subhead">Definitions</h3>
          <p>For the purposes of these Terms and Conditions:</p>
          <ul className="policy-list">
            <li>
              <strong>Affiliate</strong> means an entity that controls, is controlled by or is under
              common control with a party, where &ldquo;control&rdquo; means ownership of 50% or
              more of the shares, equity interest or other securities entitled to vote for election
            ...
            <li>
              ...
              Excatalyst, Inc., 675 High Street, Palo Alto, California 94301.
            </li>
            <li>
            ...
            <li>
              <strong>Terms and Conditions</strong> (also referred as &ldquo;Terms&rdquo;) mean
            ...
            <li>
              <strong>Website</strong> refers to Argide, accessible from{' '}
              <a className="security-link" href="https://argide.ai">
                https://argide.ai
              </a>
              .
            </li>
        ...
        <section id="acknowledgment" className="policy-section">
        ...
        <section id="limitation-of-liability" className="policy-section">
          ...
          <p>
            ...
            for incidental or consequential damages, which means that some of the above limitations may
            not apply. In these states, each party&apos;s liability will be limited to the greatest
        ...
        <section id="disclaimer" className="policy-section">
          ...
          <p>
            The Service is provided to You &ldquo;AS IS&rdquo; and &ldquo;AS AVAILABLE&rdquo; and
            with all faults and defects without warranty of any kind. To the maximum extent permitted
          ...
          <p>
            ...
            providers makes any representation or warranty of any kind, express or implied:
          </p>
          <ul className="policy-list">
            <li>
        ...
        <section id="eu-users" className="policy-section">
        ...
        <section id="us-compliance" className="policy-section">
          ...
          <ul className="policy-list">
            <li>
              ...
              &ldquo;terrorist supporting&rdquo; country; and
            </li>
            <li>
        ...
        <section id="severability-waiver" className="policy-section">
          <h2>Severability and Waiver</h2>
          <h3 className="security-subhead">Severability</h3>
          <p>
          ...
          <h3 className="security-subhead">Waiver</h3>
          <p>
        ...
        <section id="translation" className="policy-section">
          <h2>Translation Interpretation</h2>
          <p>
            These Terms and Conditions may have been translated if We have made them available to
            You on our Service. You agree that the original English text shall prevail in the case of
            a dispute.
          </p>
        </section>
      ...
      <div
        className="security-hero-image security-hero-image--bottom"
        role="img"
        aria-label=""
        aria-hidden="true"
      />

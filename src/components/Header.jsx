    ...
    <header className={`header ${isScrolled ? 'scrolled' : ''}`}>
      <div className="nav-container">
        ...
        <div className="mobile-actions mobile-only">
          <a href="#" className="btn-outline light mobile-contact-btn">Contact sales</a>
      ...
      {menuOpen && (
        <div className="mobile-menu">
          <a href="#" className="mobile-menu-item">Start free trial</a>
          <a href="https://dashboard.argide.ai" className="mobile-menu-item">Sign in</a>
          <a href="#" className="mobile-menu-item">Contact sales</a>
          <a href="#" className="mobile-menu-item">View demo</a>
        </div>
      )}
    </header>
  );
